#' @title Convert .tif files to .png to conserve server space.
...
#' retained, but the copied segmentation and forward warp images
#' are deleted along with their temporary directories.
#' @export
#' @md
